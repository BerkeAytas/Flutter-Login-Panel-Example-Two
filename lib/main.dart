...
import 'package:login_two/home.dart';
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Text(
                              "——————",
                              style: TextStyle(color: Colors.lightGreenAccent, fontWeight: FontWeight.w900),
                            ),
                            Padding(
                            ...
                            RaisedButton(
                                shape:
                                    RoundedRectangleBorder(side: BorderSide(color: Colors.lightGreenAccent, width: 3)),
